...
(function() {
	...
	window.play68_init = function() {
		updateShare(0);
	};
	window.play68_submitScore = function(score,bl) {
		updateShareScore(score,bl);
		Play68.shareFriend();
	};
	window.updateShare = function(score,bl) {
		Play68.setShareInfo('', '抢地主');
	};
	window.updateShareScore = function(score,bl) {
		updateShare(score,bl);
	};
	window.play68_goHome = function(){};
    window.a_s_e = window.CryptoJS;
